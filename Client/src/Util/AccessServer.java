...
public class AccessServer {
	...
	public static void AccessUserInfo() {
		try {
			Default_Socket.setClientSocket(new Socket(InetAddress.getByName("18.224.17.101"), 9000));
	...
	public static void AccessRoomChat() {
		try {
			Default_Socket.setChat(new Socket(InetAddress.getByName("18.224.17.101"), 9001));
		...
		try {
			Default_Socket.setRoomInfo(new Socket(InetAddress.getByName("18.224.17.101"), 9002));
